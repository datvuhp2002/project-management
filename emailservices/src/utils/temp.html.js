...
<body>
  <!--Subject: Login Verification Required for Your Project Manager Account-->
  <div class="container">
    <div class="header">
      <div>Prove Your <b>Project Manager</b> Identity</div>
    </div>
    <br />
    <strong>Dear,</strong>
    <p>
      We have received a login request for your <b>Project Manager</b> account. For
    ...
    <div class="footer">
      ...
      <p>
        ...
        <strong>Lac Hong Tect Website</strong>
      </p>
    </div>
  </div>
  <div style="text-align: center">
    ...
    <div class="email-info">
      <a href="{{link_verify}}">Lac Hong Tech</a> | Viet Nam
